...
public class Controller {
    ...
    public void showTime() {
        System.out.println("RentTime:" + this.lt.getRentTime() + " | " + "ReturnTime:" + this.lt.returnTime);
        System.out.println(" ");
    }

    public void showTimetakeOut() {
        System.out.println("ReturnTime:" + this.lt.returnTime);
        System.out.println(" ");
    }
